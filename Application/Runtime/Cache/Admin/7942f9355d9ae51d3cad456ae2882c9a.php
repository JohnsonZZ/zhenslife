	...
	<div id="test-right" class="test-right">
		...
		<form class="form-horizontal">
			<div class="form-group">
				<label class="col-sm-5 control-label">归属分类</label>
				<div class="col-sm-2">
					<select class="form-control">
						<option>顶级分类</option>
						<?php if(is_array($navList)): $i = 0; $__LIST__ = $navList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option>┗<?php echo ($val['nav_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</div>
			</div>
			<div class="form-group">
				<label for="inputName" class="col-sm-5 control-label">分类名</label>
				<div class="col-sm-2">
					<input type="text" class="form-control" id="inputName" placeholder="新的分类名">
				</div>
			</div>
		</form>
