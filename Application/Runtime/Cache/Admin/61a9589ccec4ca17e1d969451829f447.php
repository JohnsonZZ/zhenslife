	...
	<div id="test-right" class="test-right">
		...
		<table class="table table-hover">
				...
				<tr>
					...
					<td>内容</td>
					<td>发送时间</td>
					<td><a class="back" href="/myblog/index.php/Admin/Article/logged">返回</a></td>
				</tr>
				</thead>
				<tbody>
				<tr>
					...
					<td><?php echo ($res["sendtime"]); ?></td>
				</tr>
				<tr>
					<form class="form-inline" method="post" action="/myblog/index.php/Admin/Article/updateMessage">
					<td><input type="hidden" name="id" value="<?php echo ($res["id"]); ?>"/></td>
					<td>
						<div class="form-group">
							<label class="sr-only" for="editSender">编辑发送者</label>
							<input type="text" class="form-control" id="editSender" name="sender" placeholder="sender">
						</div>
					</td>
					<td>
						<div class="form-group">
							<label class="sr-only" for="editContent">编辑内容</label>
							<input type="text" class="form-control" id="editContent" name="content" placeholder="content">
						</div>
					</td>
					<td>
						<div class="form-group">
							<label class="sr-only" for="editTime">编辑发送时间</label>
							<input type="text" class="form-control" id="editTime" name="sendtime" placeholder="time">
						</div>
					</td>
