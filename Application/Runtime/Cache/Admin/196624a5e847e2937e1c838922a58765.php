	...
	<div id="test-right" class="test-right">
		...
		<div class="bg-log mt20">
			<table class="table table-striped table-bordered bg-white table-hover">
				...
				<tbody>
					<?php if(is_array($articleList)): $i = 0; $__LIST__ = $articleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
						<td><?php echo ($val['article_id']); ?></td>
						<td><?php echo ($val['article_title']); ?></td>
						<td><?php echo (msubstr($val['article_content'],0,20,'utf-8')); ?></td>
						<td class="center">
							<a edit="<?php echo ($val['article_id']); ?>"><span class="glyphicon glyphicon-pencil"></span></a>
						</td>
						<td class="center">
							<a delete="<?php echo ($val['article_id']); ?>"><span class="glyphicon glyphicon-remove"></span></a>
						</td>
					</tr><?php endforeach; endif; else: echo "" ;endif; ?>
					<tr>
						<td class="center" colspan="4">
							<a add="add"><span class="glyphicon glyphicon-plus-sign"></span>添加文章</a>
						</td>
					</tr>
				</tbody>	
			</table>
