...
<head>
    ...
    <link rel="icon" href="/think/myblog/Public/images/midbrand.png">
    ...
    <link rel="stylesheet" href="/think/myblog/Public/css/blog.css" />

    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
    <script src="/think/myblog/Public/js/ie-emulation-modes-warning.js"></script>
...
<nav class="navbar navbar-inverse navbar-fixed-top ">
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		    <ul class="nav navbar-nav">
				...
				<?php if(is_array($navList)): $i = 0; $__LIST__ = $navList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["child"] == null) AND ($vo["nav_id"] > 1)): ?><li><a href="<?php echo U('bbs/index');?>"><?php echo ($vo["nav_name"]); ?> </a></li>
					<?php elseif($vo["child"] != null): ?>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo ($vo["nav_name"]); ?> <span class="caret"></span></a>
							<ul class="dropdown-menu">
							<?php if(is_array($vo["child"])): $i = 0; $__LIST__ = $vo["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$child): $mod = ($i % 2 );++$i; if($i == 1): ?><li><a href="#"><?php echo ($child["nav_name"]); ?> </a>
								<?php else: ?>
									<li role="separator" class="divider"></li>		
									<li><a href="#"><?php echo ($child["nav_name"]); ?> </a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
							</ul>
		    ...
		    <ul class="nav navbar-nav navbar-right">
				...
				<?php else: ?>
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
						<div class="avatar">
							<img src="/think/myblog/Public/images/touxiang.jpg" width="20px">
						<span class="caret"></span>
						</div> 
    ...
    <div class="container mt50">
	  <img src="/think/myblog/Public/images/header.jpg" class="img-responsive mt10" alt="Responsive image">
      <div class="row mt10">
        <div class="col-sm-8">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="hot">
				<p><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span><a href="<?php echo U('Home/Article/index/id/12');?>">IT痴汉的工作现状</a><span class="fr">2016-03-19</span></p>
		...
		<div class="tab-content">
			<?php if(is_array($articleList)): $i = 0; $__LIST__ = array_slice($articleList,0,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i == 1): ?><div class="tab-pane active" id="article<?php echo ($vo[0]["article_navid"]); ?>">
					<p><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span><a href="<?php echo U('Home/Article/index/id/'.$vo[0][article_id]);?>"><?php echo ($vo[0]["article_title"]); ?></a><span class="fr"><?php echo ($vo[0]["article_time"]); ?></span></p>
					<p><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span><a href="<?php echo U('Home/Article/index/id/'.$vo[1][article_id]);?>"><?php echo ($vo[1]["article_title"]); ?></a><span class="fr"><?php echo ($vo[1]["article_time"]); ?></span></p>
					<p><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span><a href="<?php echo U('Home/Article/index/id/'.$vo[2][article_id]);?>"><?php echo ($vo[2]["article_title"]); ?></a><span class="fr"><?php echo ($vo[2]["article_time"]); ?></span></p>
					<p><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span><a href="<?php echo U('Home/Article/index/id/'.$vo[3][article_id]);?>"><?php echo ($vo[3]["article_title"]); ?></a><span class="fr"><?php echo ($vo[3]["article_time"]); ?></span></p>				
				</div>
				<?php else: ?>
		...
		<div class="tab-content">
			<?php if(is_array($articleList)): $i = 0; $__LIST__ = array_slice($articleList,9,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="tab-pane active" id="article<?php echo ($vo[0]["article_navid"]); ?>">
					<p><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span><a href="<?php echo U('Home/Article/index/id/'.$vo[0][article_id]);?>"><?php echo ($vo[0]["article_title"]); ?></a><span class="fr"><?php echo ($vo[0]["article_time"]); ?></span></p>
					<p><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span><a href="<?php echo U('Home/Article/index/id/'.$vo[0][article_id]);?>"><?php echo ($vo[1]["article_title"]); ?></a><span class="fr"><?php echo ($vo[1]["article_time"]); ?></span></p>
					<p><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span><a href="<?php echo U('Home/Article/index/id/'.$vo[0][article_id]);?>"><?php echo ($vo[2]["article_title"]); ?></a><span class="fr"><?php echo ($vo[2]["article_time"]); ?></span></p>
					<p><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span><a href="<?php echo U('Home/Article/index/id/'.$vo[0][article_id]);?>"><?php echo ($vo[3]["article_title"]); ?></a><span class="fr"><?php echo ($vo[3]["article_time"]); ?></span></p>				
    ...
    <div class="bg-white text-center mb20 pb20">
		<div class="p10" style="background-color:#B4DAF0">
			<img src="/think/myblog/Public/images/touxiang.jpg" alt="头像" class="img-circle mb5" width="50px" height="50px" />
            <h5 class="no-margin font-bold"><?php echo ($userList["user"]); ?></h4>
			</div>
        ...
        <div class="row">
			...
			<div class="col-sm-3 blog-border-right mt5">
			    <a href="#">文章 <span class="badge"><?php echo ($userList["article"]); ?></span></a>
			</div>
...
<script src="/think/myblog/Public/js/ie10-viewport-bug-workaround.js"></script>
<script>
	$("#sign").click(function(){
		layer.open({
			type: 1, 
