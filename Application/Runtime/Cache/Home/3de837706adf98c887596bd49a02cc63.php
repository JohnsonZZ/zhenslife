				...
				<div class="col-sm-8">
					...
					<?php if(is_array($articleList)): $i = 0; $__LIST__ = $articleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$aList): $mod = ($i % 2 );++$i;?><div class="list-group list-group-mb">
							<div class="list-group-item">
								<h4 class="font-bold"><a href="<?php echo U('Home/Article/theme/id/'.$aList[article_id]);?>"><?php echo ($aList["article_title"]); ?></a><small class="pull-right">发布时间：<?php echo ($aList["article_time"]); ?> </small></h4>
								<p>
									<span>作者：超级管理员 </span>
									<span class="pl20">浏览:20</span>
									<small class="pull-right">
										<span class="badge bg-info">评论:20</span>
										<span class="badge bg-info">点赞:20</span>
									</small>
								</p>
							</div>
